  ...
  <div id="between-top">
    <div class="container col-7">
      <div id="border-main">
        ...
        ผู้ว่าจ้างงาน : คุณ <?php echo $rows['fname']; ?>&nbsp;&nbsp;<?=$rows['lname']; ?><br>
        สถานที่&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?=$_POST['Place']; ?>
        </div>
        ...
        <tbody>
          ...
          <?php
          $sqls="select ProductName, ProductPrice from products where productID='$_POST[ProductChair]'";
          $results=$db->query($sqls);
          $rowse=$results->fetch_array(MYSQLI_ASSOC);
