...
$sql="insert into em_damaged(tool_date, tool_name, tool_problem, tool_status, tool_pic) values('$_POST[tool_date]','$_POST[tool_name]','$_POST[tool_problem]','$tool_status_f','$member_photo_name')";
