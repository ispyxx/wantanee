      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <article class="card-body">
            <form action="?page=rental_confirm_update" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="JavaScript:return fncSubmit();">
              <br>
...
<!--
              ...
              <?php
               ...
               // echo $sql;exit;
               $sql="select * FROM rent left join rentdetails on rent.RentID = rentdetails.RentID where rent.rentID='$_GET[RentID]'";
               $sqll="select * FROM rent left join rentdetails on rent.RentID = rentdetails.RentID left join products on rentdetails.productID = products.productID where rent.rentID='$row[RentID]'";
               ...
               while($rows=$result->fetch_array(MYSQLI_ASSOC)){
                  $data[$i]=$rows;
                 $i++;
                 // print_r($data[0]['ProductName']);exit;
               }
...
// print_r($data[2]);
              ...
              <div class="row">
                ...
                <div class="col">
                  <div id="margin-boxx">
                    <input type="number" name="AmountTent" id="AmountTent" min="1" max="50" style="height: 37px; width: 80px;" value="<?=$data[0]['Amount'];?>">
                  </div>
                </div>
              </div>
              <hr class="style7">
              <div class="row">
                ...
                <div class="col-md-3" id="input-numberr">
                  <div id="margin-between-bottom-textbox"></div> <div id="margin-between-bottom"></div> <input type="number"style="height: 37px; width: 80px;" name="AmountTable" id="AmountTable" min="1" max="50" style="height: 37px;" value="<?=$data[1]['Amount'];?>">
                </div>
              ...
              <div class="row">
                <div class="col-md-5" id="input-number">
                  เก้าอี้&nbsp;&nbsp;&nbsp;(ราคา 5 บาท/ตัว)  <div id="margin-between-bottom"></div> <input type="number" name="AmountChair" id="AmountChair" min="1" max="50" style="height: 37px; width: 80px;" value="<?=$data[2]['Amount'];?>">
                </div>
              </div>
